<div class="tpl_blog_title">
    ...
    <div class="tpl_blog_body">
		...
		<div style="margin-top:10px; padding:10px; text-align:center; background-color:#EEE;"><a href="index.php?{$smarty.const._NODE}={$smarty.const._PLUGIN}&amp;op=get&amp;id={$plugin_view.id}" title="{t 1=DOWNLOAD}" rel="tooltip">{t 1=DOWNLOAD}</a></div>
		<!-- TAGS begin -->
