<div class="tpl_blog_title">
    ...
    <div class="tpl_blog_tools">
        ...
        <div style="text-align:right;"><a href="javascript:void(0);" onclick="javascript:openPopup('{$sys_site_url}/index.php?{$smarty.const._NODE}={$smarty.const._PLUGIN}&amp;op=rss&amp;sec={$plugin_view.sname}&amp;cat={$plugin_view.cname}','600','400')" title="{t 1=RSS}" rel="tooltip"><img src="templates/{$sys_template}/images/rss.gif" alt="{t 1=RSS}" /></a></div>
	</div>
    ...
    <div class="tpl_blog_body">
		...
		<div style="margin-top:10px; padding:10px; text-align:center; background-color:#EEE; font-weight:bold;"><a href="index.php?{$smarty.const._NODE}={$smarty.const._PLUGIN}&amp;op=get&amp;id={$plugin_view.id}" title="{t 1=DOWNLOAD}" rel="tooltip">{t 1=DOWNLOAD}</a></div>
		<!-- TAGS begin -->
